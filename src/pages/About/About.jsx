...
function About() {
  return (
    <Container className="mt-5 mb-5 bg-same p-5">
        ...
        <Col sm={8}>
          <Card>
            <Card.Body>
              ...
              <Card.Text>
                <p>
                  I'm a skilled full-stack software engineer focused on backend
                  development. During 4+ years of my career I've worked on
                  ...
                  optimization, migrating codebase to different technologies and
                  also some experience with mentoring junior developers. I'm
                  ...
                  best practices. I'm a strong problem solver and a reliable,
